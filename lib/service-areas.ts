...
/** One entry per `/local-services/[slug]` page. Set `heroImage` to a path under `public/` (e.g. `/images/local/madison-hero.jpg`) to show a photo hero; omit for the default gradient. */
type LocalDroneServicePageDef = {
	county: CountyName
	slug: string
	title: string
	serviceType: string
...
const localDroneServicePageDefs = [
	{
		...
		heroImage: '/images/local/madison-county-row-crop.jpg',
	...
	},
	{
		...
		heroImage: '/images/local/limestone-county-cotton-crop.jpg',
		serviceType: 'Drone spraying',
		metaDescription:
	...
	},
	{
		...
		heroImage: '/images/local/morgan-county-cotton-crop.jpg',
	...
	},
	{
		...
		heroImage: '/images/local/cullman-county-hay-field.jpg',
	...
	},
	{
		...
		heroImage: '/images/local/lawrence-county-soybean-crop.jpg',
...
] as const satisfies readonly LocalDroneServicePageDef[]
...
export type LocalDroneServicePage = (typeof localDroneServicePages)[number] & {
	/** Present when the def sets `heroImage`; used for hero + Open Graph. */
	heroImage?: string
}

export function getLocalDroneServicePage(slug: string): LocalDroneServicePage | undefined {
	return localDroneServicePages.find(page => page.slug === slug) as LocalDroneServicePage | undefined
}
