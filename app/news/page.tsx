...
export const metadata: Metadata = {
	...
	openGraph: {
		title: 'News & Articles | North Alabama Drone Applicators',
		description: 'Practical articles about agricultural drone spraying and spreading for North Alabama growers.',
		url: '/news',
...
// Optional: set to a public image path (example: "/images/news-hero.jpg").
const newsHeroImage: string | null = '/images/news/agricultural_drone_cornfield.png'
			...
			<section className="relative overflow-hidden bg-[color:var(--color-primary)] pt-28 text-white lg:pt-36">
				{newsHeroImage ? (
					<>
						<Image
							src={newsHeroImage}
							alt="North Alabama Drone Applicators news"
							fill
				...
				<div className="container-page">
					{featured ? (
						<RevealOnScroll>
							...
							>
								<div className="relative flex min-h-64 flex-col justify-between overflow-hidden rounded-[var(--radius-lg)] bg-[color:var(--color-primary)] p-6 text-white">
									{featured.heroimage ? (
										<>
											<Image
									...
									<p className="relative z-10 font-heading text-3xl font-semibold text-white">{featured.title}</p>
								</div>
					...
					{remainingArticles.length > 0 ? (
						<div className="mt-8 grid gap-5 md:grid-cols-2">
							{remainingArticles.map(article => (
								...
								>
									{article.heroimage ? (
										<div className="relative -m-3 mb-4 aspect-[16/9] overflow-hidden rounded-[var(--radius)]">
											<Image
