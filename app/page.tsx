  ...
  return (
    <div className="bg-[#f9f6f0] text-[#1a1a1a]">
      <main>
            ...
            <div className="grid items-start gap-8 lg:grid-cols-2">
              <RevealOnScroll className="max-w-3xl">
                ...
                <p className="mt-5 text-lg leading-8 text-[#e8e8e8] sm:text-xl">
                  Agricultural drone services built for North Alabama farmers -
                  from stand counts in April to spray applications in August.
                </p>
              ...
              <RevealOnScroll className="w-full" >
                <div id="lead-form" className="rounded-xl bg-white/95 p-3 shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
                  <LeadInterestForm />
                </div>
              </RevealOnScroll>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 sm:px-10 lg:px-12">
            <RevealOnScroll>
              <h2 className="font-heading text-3xl font-bold text-[#1e3a0f] sm:text-4xl">
                North Alabama Farming Is Getting Harder. Your Tools Should Get
                Smarter.
              </h2>
            </RevealOnScroll>
              ...
              {[
                ...
                <RevealOnScroll key={item.title}>
                  <article className="topo-card rounded-xl p-6">
                    ...
                    <h3 className="mt-3 font-heading text-2xl font-semibold text-[#2d5016]">
                      {item.title}
                    </h3>
        ...
        <section id="services" className="section-pad bg-white">
          <div className="mx-auto max-w-6xl px-6 sm:px-10 lg:px-12">
            ...
            <div className="mt-10 grid items-center gap-8 lg:grid-cols-2">
              ...
              />
              <RevealOnScroll>
                <h3 className="font-heading text-2xl font-bold text-[#2d5016]">
                  Precision Spray Applications
                </h3>
                <p className="mt-4 text-[#4c4c4c]">
                  We support cotton, corn, soybeans, and wheat with fungicide,
                  herbicide, and foliar nutrient applications. Drone
                  applications are especially useful near homes, drainage
                  ditches, and parts of the field where ground rigs struggle.
                </p>
              </RevealOnScroll>
            </div>
            ...
            <div className="mt-10 grid items-center gap-8 lg:grid-cols-2">
              <RevealOnScroll className="lg:order-1">
                ...
                <p className="mt-4 text-[#4c4c4c]">
                  Multispectral mapping helps identify stand gaps, pest pressure,
                  and possible nutrient issues earlier. You receive
                  georeferenced maps you can use with your agronomist or co-op
                  for decisions in-season.
                </p>
              </RevealOnScroll>
              <Image
        ...
        <section id="explainer" className="section-pad bg-[#f9f6f0]">
          <div className="mx-auto max-w-4xl px-6 sm:px-10">
            ...
            <div className="mt-8 grid gap-4 text-center sm:grid-cols-3">
              {[
                ...
                <RevealOnScroll key={stat} className="rounded-xl border border-[#e3ddd0] bg-white p-5">
          ...
          <div className="mx-auto max-w-6xl px-6 sm:px-10 lg:px-12">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                {
                  quote:
                    "The map layers gave us better conversations with our co-op about where to focus first.",
                  name: "C. Green",
            ...
            <div className="mt-7 grid gap-3 text-center text-sm text-[#6b6b6b] sm:grid-cols-3">
              <div className="rounded-md border border-[#e3ddd0] bg-white p-3">Alabama Farmers Federation (Placeholder)</div>
        ...
        <section className="section-pad relative overflow-hidden bg-[#1e3a0f]">
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-6 sm:px-10">
            <RevealOnScroll>
              <h2 className="font-heading text-3xl font-bold text-white sm:text-4xl">Reserve Your Free Field Assessment</h2>
              <p className="mt-4 text-[#d3ebc9]">
                We are onboarding a limited number of farms in North Alabama for
                Fall 2026. Secure your spot now with no commitment required.
              </p>
            </RevealOnScroll>
            <p className="mt-6 text-sm text-[#d3ebc9]">
              The form is at the top of this page so you can submit quickly from
              mobile or desktop.
            </p>
          </div>
        </section>
        ...
        <footer className="border-t border-[#d9d3c6] bg-white">
          <div className="mx-auto flex max-w-6xl flex-col gap-5 px-6 py-8 text-sm text-[#5a5a5a] sm:px-10 lg:px-12">
            <p className="font-heading text-xl text-[#1e3a0f]">
