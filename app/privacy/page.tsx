          ...
          <div className="prose prose-neutral max-w-3xl text-[color:var(--fg)]">
            <LegalBlock title="1. Who We Are">
              <p>
                ...
                (&ldquo;North Alabama Drone Applicators,&rdquo; &ldquo;we,&rdquo;
                &ldquo;us,&rdquo; or &ldquo;our&rdquo;), an Alabama limited
                liability company. Our primary service area is the Tennessee
                Valley in North Alabama.
              </p>
            </LegalBlock>

            <LegalBlock title="2. Information We Collect">
              <p>
                We collect information that you give us and information that
                is automatically generated when you use the site.
              </p>
              ...
              <ul>
                <li>
                  ...
                  our interest list, contact forms, or guide requests — such
                  as your name, email address, phone number, county, crop
                  type, approximate acreage, and the services you&rsquo;re
                  interested in;
                </li>
                <li>
                  <strong>Communications</strong> you send us by email, text,
                  or phone;
                </li>
                <li>
              ...
              <ul>
                <li>
                  ...
                  browser type, device type, pages visited, referring URLs,
            ...
            <LegalBlock title="3. How We Use Information">
              ...
              <ul>
                <li>
                  ...
                  Spray + Spread overview), and follow up about scheduling;
                </li>
                <li>
                  Add you to a priority or interest list when you request it
                  and contact you about service availability;
                </li>
                <li>
                  Plan routes, prepare quotes, perform services, issue
                  invoices, and maintain business records;
                </li>
                <li>
            ...
            <LegalBlock title="4. How We Share Information">
              <p>
                We share personal information only as needed to run our
                business and as described below:
              </p>
              <ul>
                <li>
                  <strong>Service providers</strong> that help us operate the
                  site and communicate with you — for example, website and
                  form hosting, database hosting, email delivery, analytics,
                  document generation, and customer messaging tools. These
                  providers are only permitted to use your information to
                ...
                <li>
                  <strong>Legal and safety</strong> — when we reasonably
                  believe disclosure is required by law, court order, or to
            ...
            <LegalBlock title="5. Cookies and Analytics">
              <p>
                ...
                let you refuse or delete cookies through your browser
                settings; doing so may affect how parts of the site function.
              </p>
            </LegalBlock>

            <LegalBlock title="6. Email, Text, and Phone Communications">
              <p>
                When you submit a form or contact us, you are providing
                consent for us to respond by email, phone, or text about your
                request, our services, and availability. You can ask us to
                stop contacting you at any time by replying &ldquo;STOP&rdquo;
                to a text message, using the unsubscribe link in an email, or
                sending us a written request. Message and data rates may
                apply to text messages from your carrier.
              </p>
            </LegalBlock>
            ...
            <LegalBlock title="7. Data Retention">
              <p>
                ...
                including providing services, maintaining business and tax
                records, resolving disputes, and complying with our legal
                obligations.
              </p>
            </LegalBlock>
            ...
            <LegalBlock title="8. Security">
              <p>
                ...
                loss, theft, unauthorized access, disclosure, and alteration.
            ...
            <LegalBlock title="9. Your Choices and Rights">
              ...
              <ul>
                ...
                <li>
                  Opt out of marketing emails or texts at any time;
                </li>
                <li>
            ...
            <LegalBlock title="10. Children's Privacy">
              <p>
                ...
                13. If you believe a child has submitted information, please
            ...
            <LegalBlock title="11. Third-Party Websites">
              <p>
                ...
                don&rsquo;t control. This policy does not apply to those
            ...
            <LegalBlock title="12. Changes to This Policy">
              <p>
                ...
                &ldquo;Effective&rdquo; date above and, where appropriate,
                provide additional notice. Continued use of the site after an
                update takes effect means you accept the revised policy.
              </p>
            </LegalBlock>
