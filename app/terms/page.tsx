          ...
          <div className="prose prose-neutral max-w-3xl text-[color:var(--fg)]">
            <LegalBlock title="1. About Us">
              <p>
                ...
                liability company. References to &ldquo;you&rdquo; mean the
                person visiting the site or requesting services.
              </p>
            </LegalBlock>
            ...
            <LegalBlock title="3. Services We Offer">
              <p>
                ...
                services, including but not limited to the aerial application
                of liquid crop protection products and dry materials such as
                cover crop seed, fertilizer, lime, and pasture inputs. All
            ...
            <LegalBlock title="4. Eligibility and Accurate Information">
              <p>
                ...
                into contracts to request services. You agree to provide
                accurate, current, and complete information (including field
                locations, acreage, crop, product preferences, and contact
                details) and to promptly update that information if it
                changes.
              </p>
            </LegalBlock>
            ...
            <LegalBlock title="5. Scheduling, Weather, and Site Conditions">
              ...
              <ul>
                ...
                <li>
                  Provide reasonable access to loading areas, water sources
                  (if applicable), and the fields to be treated.
                </li>
              </ul>
            </LegalBlock>
            ...
            <LegalBlock title="7. Payment Terms">
              <p>
                ...
                collection costs, including attorney fees, on past-due
                amounts.
              </p>
            </LegalBlock>
            ...
            <LegalBlock title="9. Assumption of Risk and Limitation of Liability">
              <p>
                Agricultural production is inherently subject to weather,
                pests, disease, market conditions, and other variables beyond
                our control. We cannot and do not guarantee specific yields,
                kill rates, coverage levels, stand counts, or economic
                outcomes.
              </p>
              <p>
                <strong>
                ...
                profits, loss of yield, or crop damage that is not directly
            ...
            <LegalBlock title="10. Indemnification">
              <p>
                ...
                contractors from and against any third-party claims arising
                out of: (a) inaccurate information you provided; (b) your
                failure to identify sensitive areas or neighbors; (c) your
                violation of law; or (d) your breach of these Terms.
              </p>
            </LegalBlock>
            ...
            <LegalBlock title="11. Intellectual Property">
              <p>
                ...
                Spray + Spread overview — is owned by North Alabama Drone
                Applicators LLC or its licensors and is protected by
                intellectual property laws. You may view and share this
                content for personal, non-commercial, informational purposes.
                You may not copy, modify, redistribute, or use it for
            ...
            <LegalBlock title="12. Website Use and Conduct">
              <p>
                You agree not to use this website to: (a) violate any law;
                (b) send spam or unsolicited commercial communications;
                (c) interfere with or attempt to disrupt the site; (d) gain
            ...
            <LegalBlock title="13. Third-Party Links and Services">
              <p>
                The website may link to third-party websites or services that
                we do not control (for example, forms, analytics providers, or
            ...
            <LegalBlock title="14. Disclaimers">
              <p>
                ...
                for a particular purpose, and non-infringement. Information on
                this site is provided for general informational purposes only
                and is not agronomic, legal, or financial advice.
              </p>
            </LegalBlock>
            ...
            <LegalBlock title="15. Changes to These Terms">
              <p>
                ...
                Continued use of the website or our services after the updated
                Terms take effect constitutes your acceptance of them.
              </p>
            </LegalBlock>
            ...
            <LegalBlock title="16. Governing Law and Venue">
              <p>
                ...
                arising out of or relating to these Terms or our services
                shall be brought exclusively in the state or federal courts
                located in Alabama, and you consent to the personal
